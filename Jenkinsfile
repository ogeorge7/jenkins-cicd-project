...
pipeline {
    ...
    stage('SonarQube Scan') {
      steps {
        sh """mvn sonar:sonar \
          ...
          -Dsonar.host.url=http://172.31.31.106:9000 \
          -Dsonar.login=f034a98f45c8cd083dbcab596160d77d559b84d9"""
      }
    }
  ...
  post {
    always {
        ...
        slackSend channel: '#masky-jenkins-cicd-pipeline-alerts', //update and provide your channel name
